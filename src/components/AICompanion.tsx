...
import { Brain, Shield, Star, Heart, Sparkles, Zap, MessageCircle, Users, Award, Clock, Bot, Mic, Send } from 'lucide-react';
...
export function AICompanion() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-50 via-serenity-50 to-mindful-50 -mt-20 pt-20">
      ...
      <div className="relative z-10 h-screen flex flex-col">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div className="flex items-center space-x-4 sm:space-x-6">
                ...
                <div>
                  ...
                  <p className="text-white/90 text-sm sm:text-base lg:text-lg">Your intelligent mental health support system</p>
        ...
        {/* Main Chat Container */}
        <div className="flex-1 relative overflow-hidden bg-white/95 backdrop-blur-xl">
          {/* Loading State */}
          {isInitializing && (
